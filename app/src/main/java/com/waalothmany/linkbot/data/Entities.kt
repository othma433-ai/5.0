...
@Entity(tableName = "whatsapp_instances", indices = [Index(value = ["packageName", "profileIdentity", "installationIdentity"], unique = true)])
data class WhatsAppInstanceEntity(
    @PrimaryKey val id: String,
    val packageName: String,
    val label: String,
    val kind: String,
    val profileIdentity: String = "current",
    val installationIdentity: String = "default",
