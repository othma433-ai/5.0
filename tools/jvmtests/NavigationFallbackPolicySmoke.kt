...
fun main() {
    ...
    check(NavigationFallbackPolicy.decide(groupsFound = false, chatsFound = true, missCount = 4, inChat = false) == NavigationFallbackAction.ANCHOR_CHATS)
    check(NavigationFallbackPolicy.decide(groupsFound = false, chatsFound = true, missCount = 7, inChat = false) == NavigationFallbackAction.ANCHOR_CHATS)
    check(NavigationFallbackPolicy.decide(groupsFound = false, chatsFound = true, missCount = 8, inChat = false) == NavigationFallbackAction.FALLBACK_ALL_CHATS)
